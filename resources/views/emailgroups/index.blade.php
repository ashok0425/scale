...
<div>
    <h6 class="text-white">Email Group</h6>
                                 ...
                                 <div>
                        <a href="{{ route('admin.emailgroups.create') }}" class="btn btn-sm  btn btn-sm btn-info mx-2"><i class="fas fa-plus"></i> Add Group</a>
                    </div>
                </div>
                            ...
                            @foreach($groups as $group)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            class="btn btn-sm  btn btn-sm btn-icon btn btn-sm btn-light btn btn-sm btn-hover-primary btn btn-sm btn-sm mx-3">
                                ...
                                >
                                    <i class="fas fa-trash"></i>
                                        ...
                                        <a href="{{route('admin.emails.index',['group_id'=>$group->id])}}" class="btn btn-sm  btn btn-sm btn-info btn btn-sm btn-sm">Add Emails</a>
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
