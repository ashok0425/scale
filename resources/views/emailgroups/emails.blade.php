...
<div class="d-flex flex-column-fluid" id="app">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div v-if="selectedEmails.length" class="mb-3">
                    <button class="btn btn-sm  btn btn-sm btn-primary" data-toggle="modal" data-target="#groupModal">
                        Add to Group
                    </button>
                </div>
 ...
 <div>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-sm  btn btn-sm btn-success">Import</button>
          <button type="button" class="btn btn-sm  btn btn-sm btn-secondary" data-dismiss="modal">Cancel</button>
        </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="groupModal" tabindex="-1" role="dialog" aria-labelledby="groupModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <h6 class="text-warning">Are you sure you want to add emails to this group?</h6>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-sm  btn btn-sm btn-success">Add</button>
          <button type="button" class="btn btn-sm  btn btn-sm btn-secondary" data-dismiss="modal">Cancel</button>
        </div>
      </form>
    </div>
