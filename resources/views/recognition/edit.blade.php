    ...
    <div class="container">
        <div class="card">
            <div class="card-header bg-dark">
                <h5 class="card-title text-white mb-0">Edit Recognition</h5>
            </div>

            <form action="{{ route('recognitions.update',$recognition) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="card-body">
                    <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="name" id="name" class="form-control" required value="{{old('name',$recognition->name)}}">
                    </div>
                   ...
                   <div class=" col-md-6 mb-5">
                        ...
                        <img src="{{ getImage($recognition->thumbnail) }}" alt="" width="100">
                    </div>
                </div>
                </div>
